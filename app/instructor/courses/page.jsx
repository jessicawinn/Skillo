  ...
  useEffect(() => {
    ...
    const fetchCourses = async () => {
      ...
      try {
        ...
        // For each course, fetch its thumbnail and enrolled students count
        const coursesWithDetails = await Promise.all(
          courses.map(async (course) => {
            ...
            try {
              ...
              thumbnail = imagesData.urls && imagesData.urls.length > 0 ? imagesData.urls[0] : thumbnail;
            } catch {}
        ...
        setInstructorCourses(coursesWithDetails);
      } catch {
